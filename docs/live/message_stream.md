...
| title | str | 活动标题 |  |
| room_id | num | 主直播间id |  |
| copy_writing | str | 提示文本 |  |
| bg_image | str | 背景图片 |  |
| sub_slt_color | str | 切换按钮颜色? |  |
| sub_bg_color | str | 切换按钮背景颜色? |  |
| sub_text_color | str | 切换按钮文本颜色? |  |
| view_type | num |  |  |
| room_list | arr | 房间列表 | 不包括“未直播”状态的直播间 |
| relation_view | arr | 详细关系? | 不包括“未直播”状态的直播间 |
| view_pattern | num |  |  |
| gather_room_list | arr |  | 空数组? |
